...
Ship the tiers above for the course; build the seams so lifting the options constraint later is bounded work. Full detail in `Upgrade_Path.md`.
...
Problem · the system in one diagram · what makes it different · how success is measured · scope and risk · where it stands. *Built: `PROJECT_BETA_Product_Demo.pptx` with speaker notes, and `Product_Demo.md` as the presenting script.* **Needs a Rev 11 pass** — the deck still shows the news gate and the six-rung ladder.
